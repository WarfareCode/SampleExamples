...
implements ActionListener, IAgAnimationJToolBarEventsListener
{
	...
	private final static String		s_TITLE				= "CustomApp_AWT_STK_Objects_Tutorial_Begin";
	...
	throws Throwable
	{
		...
		// TODO: define the STK application and uncomment the below lines
        ...
        // TODO: Add a listener for STK Object Root events with the RootEventsAdapter using addIAgStkObjectRootEvents2 method  and uncomment below line
		...
		// TODO: define the STK Globe Cntrl using m_AgGlobeCntrlClass variable and uncomment below lines
		//this.m_AgGlobeCntrlClass.setBackColor(stkxColor);
		//this.m_AgGlobeCntrlClass.setBackground(awtColor);
        // TODO: Assign the m_AgGlobeCntrlClass variable for the Globe Cntrl as a component of the frame's content pane., using a center borderlayout. Also uncomment the below lines
		//this.getContentPane().add(/*globe cntrl variable*/, /* Center Border Layout*/);
