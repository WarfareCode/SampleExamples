...
public class SampleCode
{
	...
	throws Throwable
	{
		try
		{
			...
			// TODO: Get the available markers type as an object array from the Scenario objects VO interface (IAgScVO). Also uncomment the below lines
	...
	throws Throwable
	{
		try
		{
    		...
    		// a variable of type AgFacilityClass called fac and uncomment the below lines
			...
			// Also uncomment code lines belows
			...
			//mdl.setVisible(true);
    		// TODO: set the model to use model type of AgEModelType.E_MODEL_FILE and uncomment the line below
			//mdl.setScaleValue(0);
    		// TODO: Create a IAgVOModelFile variable called mdlFile 
			// by casting the return of the mdl.getModelData() method call. Also uncomment the line below
	...
	throws Throwable
	{
		try
		{
			...
			// to a variable of type IAgSaGraphics called sa2D. Also uncomment the code lines below
	...
	throws Throwable
	{
		try
		{
    		...
    		// Call this new variable voVector. Also uncomment the code lines below
	...
	throws Throwable
	{
		try
		{
    		...
    		// assign its value to a variable call ddc. Also uncomment the code lines below
	...
	throws Throwable
	{
		...
		// the satobj variable and assign it to a variable call dpc. Also uncomment the code lines below
		...
		//			Object startTime = interval.getStartTime2_AsObject();
		//			Object stopTime = interval.getStopTime2_AsObject();
