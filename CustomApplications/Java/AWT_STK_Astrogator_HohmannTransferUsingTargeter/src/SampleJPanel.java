...
extends JPanel
{
	...
	private final static String	s_STEP2_TEXT	= "Define the Initial State";
	private final static String	s_STEP3_TEXT	= "Propagate the Parking Orbit";
	private final static String	s_STEP4_TEXT	= "Target Sequence containing Maneuver into Transfer Ellipse";
	private final static String	s_STEP5_TEXT	= "Propagate the Transfer Orbit to Apogee";
	private final static String	s_STEP6_TEXT	= "Target Sequence container Maneuver into the Outer Orbit";
	private final static String	s_STEP7_TEXT	= "Propagate the Outer Orbit";
	private final static String	s_STEP8_TEXT	= "Run MCS";
	private final static String	s_STEP9_TEXT	= "Display Results";
