...
implements ActionListener
{
	...
	private final static String s_TITLE = "CustomApp_AWT_STK_Plugins_AccessConstraints_Range";
	...
	private final static String 	s_JavaPluginName = "Java.Range";
	...
	{
		this.m_AgStkObjectRootClass.newScenario("Java_Auto_Stk_Plugin_AccCnstrnt_Range");
	...
	throws AgException
	{
		...
		if(pluginIsAvailable(acc, s_JavaPluginName))
		{
			...
			if(constraintType == AgEAccessConstraints.E_CSTR_PLUGIN)
			{
				...
				acp.setMax(new Double(10.0)); // 10 km

				acp.setEnableMin(true);
				acp.setMin(new Double(1.0));  // 1 km
			}
		}
		else
		{
