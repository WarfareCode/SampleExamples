...
public class SampleCode
{
	...
	throws Throwable
	{
		...
		this.m_AgStkObjectRootClass.executeCommand("VO */Satellite/" + data.SatelliteName + "/Sensor/" + data.SensorName + " Obscuration Compute \""+data.StartTime+"\" \""+data.StopTime+"\" "+data.TimeStep+" " + "\"" + data.ReportName + "\"");
	}
}