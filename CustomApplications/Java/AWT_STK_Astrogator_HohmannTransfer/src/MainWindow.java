...
implements ActionListener, IAgAnimationJToolBarEventsListener, IAgMsgViewerJToolBarEventsListener
{
	...
	private final static String		s_TITLE				= "CustomApp_AWT_STK_Astrogator_HohmannTransfer";
	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			{
				this.m_SampleCode.step2_createSatellite();
			...
			{
				this.m_SampleCode.step3_defineInitialState();
			...
			{
				this.m_SampleCode.step4_propagateTheParkingOrbit();
			...
			{
				this.m_SampleCode.step5_maneuverIntoTheTransferEllipse();
			...
			{
				this.m_SampleCode.step6_propagateTheTransferOrbitToApogee();
			...
			{
				this.m_SampleCode.step7_maneuverIntoTheOuterOrbit();
			...
			{
				this.m_SampleCode.step8_propagateTheOuterOrbit();
			...
			{
				this.m_SampleCode.step9_runMCS();
			...
			{
				String data = this.m_SampleCode.step10_getResults();
			...
			{
				this.m_SampleCode.step11_closeScenario();
