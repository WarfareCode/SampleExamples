...
public final class Main
{
	...
	throws AgException
	{
		...
		this.m_Shell.setText("CustomApp_SWT_STK_X_Map_Basic");
		...
		this.m_AgMapCntrlClass = new AgMapCntrlClass(this.m_Shell, SWT.NONE);
		this.m_AgMapCntrlClass.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
	}
	...
	implements Listener
	{
		public void handleEvent(Event e)
		{
			...
			StringBuffer msg = new StringBuffer();
			msg.append("Name:\t\t\tCustomApp_SWT_STK_X_Map_Basic");
			msg.append("\n");
