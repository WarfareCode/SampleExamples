...
import codesnippets.STKGraphicsCodeSnippet;
...
implements IAgStkGraphicsSceneEvents
{
	...
	public DistanceOverlay(STKGraphicsCodeSnippet cs, IAgStkGraphicsSceneManager manager, AgStkGraphicsSceneClass scene) 
	throws AgCoreException
	{
		super(cs, manager, true, new Double(0.0), new Double(10000000.0), "0", "10000");
	...
	throws AgCoreException
	{
		...
		return "Current Distance:\n" + df.format(((Double)getValue()).doubleValue() / 1000.0) + " km";
	}
