...
% OBJECTMODEL M-file for ObjectModel.fig
...
%      applied to the GUI before ObjectModel_OpeningFunction gets called.  An
...
% Last Modified by GUIDE v2.5 03-Nov-2005 11:11:59
...
mto = sc.Children.New(12, 'Mto1')
tracks = mto.Tracks
oTrack = tracks.Add(123)
oTrack.Name = 'Track1'
get(oTrack)
oPoint = oTrack.Points.Add('12 Jul 2005 12:13:14.000')
oPoint.Latitude = 12
oPoint.Longitude = 23
oPoint.Altitude = 34
get(oPoint)
