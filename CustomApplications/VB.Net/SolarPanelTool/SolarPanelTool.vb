...
Public Class frmSolarPanelTool
    ...
    Public Shared Sub Main()
        ...
        If Not STKXApp Is Nothing Then
            Application.Run(New frmSolarPanelTool)
        End If
    End Sub
    ...
    Private Sub frmSolarPanelTool_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load        
        ReportFilePath = ""
        bFirstTime = True
    ...
    Private Sub frmSolarPanelTool_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        CleanReportFile()
    End Sub

    Private Sub frmSolarPanelTool_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        If Not (IsNothing(stkRootObject)) Then
            stkRootObject.CloseScenario()
        End If
    End Sub
