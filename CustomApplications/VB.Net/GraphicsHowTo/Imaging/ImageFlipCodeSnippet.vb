...
Namespace Imaging
	Class ImageFlipCodeSnippet
		Inherits CodeSnippet
		Public Sub New()
            MyBase.New("Imaging\ImageFlipCodeSnippet.vb")
        End Sub
        ...
        <AGI.CodeSnippets.CodeSnippet( _
            ...
            "System", _
            "System", _
            "AgSTKGraphicsLib~IAgStkGraphicsFlipFilter" _
            )> _
        Public Sub ExecuteSnippet(<AGI.CodeSnippets.CodeSnippet.Parameter("Scene", "Current Scene")> ByVal scene As IAgStkGraphicsScene, <AGI.CodeSnippets.CodeSnippet.Parameter("Root", "STK Object Model root")> ByVal root As AgStkObjectRoot, <AGI.CodeSnippets.CodeSnippet.Parameter("imageFile", "The image file")> ByVal imageFile As String)
            ...
            Dim image As IAgStkGraphicsRaster = manager.Initializers.Raster.InitializeWithStringUri( _
                imageFile)
            image.Flip(attachID("$flipAxes$The axes the image is flipped about$", AgEStkGraphicsFlipAxis.eStkGraphicsFlipAxisVertical))
            ...
            DirectCast(overlay, IAgStkGraphicsOverlay).Size = New Object() _
                { _
                    attachID("$overlayWidth$The width of the screen overlay$", 0.2), attachID("$overlayHeight$The height of the screen overlay$", 0.2), _
                    attachID("$overlayWidthUnit$The width unit of the screen overlay$", AgEStkGraphicsScreenOverlayUnit.eStkGraphicsScreenOverlayUnitFraction), _
                    attachID("$overlayHeightUnit$The height unit of the screen overlay$", AgEStkGraphicsScreenOverlayUnit.eStkGraphicsScreenOverlayUnitFraction) _
                }
            overlay.Texture = texture
            DirectCast(overlay, IAgStkGraphicsOverlay).Origin = attachID("$overlayOrigin$The origin of the screen overlay$", AgEStkGraphicsScreenOverlayOrigin.eStkGraphicsScreenOverlayOriginTopLeft)

            overlayManager.Add(DirectCast(overlay, IAgStkGraphicsScreenOverlay))
            '#End Region
            OverlayHelper.AddOriginalImageOverlay(manager)
            OverlayHelper.LabelOverlay(DirectCast(overlay, IAgStkGraphicsScreenOverlay), "Flipped", manager)
