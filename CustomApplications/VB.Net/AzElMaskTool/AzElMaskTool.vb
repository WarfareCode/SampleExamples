...
Public Class frmAzElMaskTool
    ...
    Public Shared Sub Main()
        ...
        If Not STKXApp Is Nothing Then
            Application.Run(New frmAzElMaskTool)
        End If
    End Sub
    ...
    Private Sub ShowReport(ByVal sReport As String)
        ...
        End If
    End Sub
    Private Sub frmAzElMaskTool_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        CleanReportFile()
    End Sub

    Private Sub frmAzElMaskTool_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        If Not (IsNothing(stkRootObject)) Then
            stkRootObject.CloseScenario()
        End If
    End Sub
