...
namespace HohmannTransfer
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (STKXApp != null)
            {
                IAgStkObjectRoot root = new AgStkObjectRootClass() as IAgStkObjectRoot;

                if (root.AvailableFeatures.IsPropagatorTypeAvailable(AgEVePropagatorType.ePropagatorAstrogator))
                {
