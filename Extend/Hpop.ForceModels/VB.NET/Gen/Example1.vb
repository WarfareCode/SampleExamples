        ...
        Try
            ...
            If (Not m_UPS Is Nothing And IsReference(m_UPS)) Then
                If (m_Enabled) Then
                    ...
                    Dim WholeDays As Integer, Year As Integer, DayOfYear As Integer, Month As Integer
                    ...
                    If (Not Result Is Nothing And IsReference(Result)) Then
                        Result.RefEpoch(AgEUtTimeScale.eUtTimeScaleUTC, WholeDays, SecsIntoDay, Year, DayOfYear, _
