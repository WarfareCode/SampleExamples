...
Function PreCompute( )
   ...
   m_showMsg = true
   Set m_intersectParams = CreateObject("AgStkRadarPlugin11.AgSTKRadarCBIntersectComputeParams")
   PreCompute = true	
...
Function GetPluginConfig( attrBuilder )
   ...
   If( m_AgAttrScope is Nothing ) Then
      ...
      Call attrBuilder.AddQuantityDispatchProperty( m_AgAttrScope, "PatchArea", "PatchArea", "PatchArea", "sqm", "sqm", 0)
      Call attrBuilder.AddQuantityDispatchProperty( m_AgAttrScope, "OffsetAngle", "OffsetAngle", "OffsetAngle", "deg", "rad", 0)
