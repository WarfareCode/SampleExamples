...
Function GetPluginConfig( attrBuilder )
   ...
   If( m_AgAttrScope is Nothing ) Then
      ...
      Call attrBuilder.AddQuantityDispatchProperty( m_AgAttrScope, "ConstantClutterCoefficient", "ConstantClutterCoefficient", "ConstantClutterCoefficient", "dB", "units", 0)
