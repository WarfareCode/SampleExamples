...
class ATL_NO_VTABLE CExample1 : 
	...
	public IDispatchImpl<IExample1, &IID_IExample1, &LIBID_AgiVGTAxesPluginCPPExampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public IAgUtPluginConfig,
	public IAgCrdnAxesPlugin
{
	public:
		...
		BEGIN_COM_MAP(CExample1)
			...
			COM_INTERFACE_ENTRY(IAgCrdnAxesPlugin)
		...
		STDMETHOD(Register)		(IAgCrdnAxesPluginResultReg* Result);
		STDMETHOD(Reset)		(IAgCrdnAxesPluginResultReset* Result, VARIANT_BOOL * pResult);
		STDMETHOD(Evaluate)		(IAgCrdnAxesPluginResultEval* Result, VARIANT_BOOL * pResult);
		STDMETHOD(Free)			();

		//==================================
		// Defined in both 
		// IAgCrdnAxesPlugin and
		// IExample1
		//==================================
	...
	private:
		...
		CComPtr<IAgCrdnConfiguredAxes>			m_ICRFAxes;
