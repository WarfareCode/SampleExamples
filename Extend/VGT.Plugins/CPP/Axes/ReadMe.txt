...
4.	This plugin has already been registered in the "VGT Axes Plugins" Category in the
	...
	<Plugin DisplayName = "CPP Axes Example" ProgID = "Agi.VGT.Axes.Plugin.Examples.CPP.Example1"/>
...
7.  Use STK documentation for directions on how to configure a VGT Axes Plugin for a 
    given satellite.
