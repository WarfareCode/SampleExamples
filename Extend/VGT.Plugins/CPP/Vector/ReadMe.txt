...
4.	This plugin has already been registered in the "VGT Vector Plugins" Category in the
	...
	<Plugin DisplayName = "CPP Vector Example" ProgID = "Agi.VGT.Vector.Plugin.Examples.CPP.Example1"/>
...
7.  Use STK documentation for directions on how to configure a VGT Vector Plugin for a 
    given satellite.
