...
4.	This plugin has already been registered in the "VGT Point Plugins" Category in the
	...
	<Plugin DisplayName = "CPP Point Example" ProgID = "Agi.VGT.Point.Plugin.Examples.CPP.Example1"/>
...
7.  Use STK documentation for directions on how to configure a VGT Point Plugin for a 
    given satellite.
