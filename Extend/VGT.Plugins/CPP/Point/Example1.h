...
class ATL_NO_VTABLE CExample1 : 
	...
	public IDispatchImpl<IExample1, &IID_IExample1, &LIBID_AgiVGTPointPluginCPPExampleLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public IAgUtPluginConfig,
	public IAgCrdnPointPlugin
{
	public:
		...
		BEGIN_COM_MAP(CExample1)
			...
			COM_INTERFACE_ENTRY(IAgCrdnPointPlugin)
		...
		STDMETHOD(Register)		(IAgCrdnPointPluginResultReg* Result);
		STDMETHOD(Reset)		(IAgCrdnPointPluginResultReset* Result, VARIANT_BOOL * pResult);
		STDMETHOD(Evaluate)		(IAgCrdnPointPluginResultEval* Result, VARIANT_BOOL * pResult);
		STDMETHOD(Free)			();

		//==================================
		// Defined in both 
		// IAgCrdnPointPlugin and
		// IExample1
		//==================================
	...
	private:
		...
		CComPtr<IAgCrdnConfiguredPoint>			m_objectConfiguredPoint;
