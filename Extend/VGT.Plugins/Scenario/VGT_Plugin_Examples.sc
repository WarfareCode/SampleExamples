...
BEGIN Scenario
    Name            VGT_Plugin_Examples

BEGIN Epoch

    Epoch        30 Oct 2009 16:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	30 Oct 2009 16:00:00.000000000
			EventEpoch
...
Start                   30 Oct 2009 16:00:00.000000000
Stop                    31 Oct 2009 16:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	30 Oct 2009 16:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          30 Oct 2009 16:00:00.000000000
    EndTime            31 Oct 2009 16:00:00.000000000
    CurrentTime        30 Oct 2009 16:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN SoftVTR
            OutputFormat     WMV
            Directory        C:\Users\hdinh\Documents\STK 10
            BaseName         Frame
            Digits           4
            Frame            0
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/PluginAxes
        *
        Satellite/PluginAxes
    END Instance
    Instance Satellite/PluginCalcScalar
        Satellite/PluginCalcScalar
    END Instance
    Instance Satellite/PluginPoint
        Satellite/PluginPoint
    END Instance
    Instance Satellite/PluginVector
        Satellite/PluginVector
    END Instance
END References
