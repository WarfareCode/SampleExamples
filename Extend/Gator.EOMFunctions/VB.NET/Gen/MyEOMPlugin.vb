    ...
    Public Function Register(ByVal RegisterHandler As AgAsEOMFuncPluginRegisterHandler) As Boolean Implements IAgAsEOMFuncPlugin.Register
        ...
        Try
            ...
            If (Not m_UPS Is Nothing And IsReference(m_UPS)) Then
                ...
                RegisterHandler.RegisterInput(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustX)
                RegisterHandler.RegisterInput(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustY)
                RegisterHandler.RegisterInput(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustZ)

                RegisterHandler.RegisterInput(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesTotalMass)
                ...
                RegisterHandler.ExcludeEvent(AgEAsEOMFuncPluginEventTypes.AgEAsEOMFuncPluginEventTypesPrePropagate)
                RegisterHandler.ExcludeEvent(AgEAsEOMFuncPluginEventTypes.AgEAsEOMFuncPluginEventTypesPreNextStep)
                RegisterHandler.ExcludeEvent(AgEAsEOMFuncPluginEventTypes.AgEAsEOMFuncPluginEventTypesPostPropagate)
    ...
    Public Function SetIndices(ByVal SetIndicesHandler As AgAsEOMFuncPluginSetIndicesHandler) As Boolean Implements IAgAsEOMFuncPlugin.SetIndices
        ...
        Try
            ...
            If (Not m_UPS Is Nothing And IsReference(m_UPS)) Then
                ...
                m_thrustXIndex = SetIndicesHandler.GetInputIndex(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustX)
                m_thrustYIndex = SetIndicesHandler.GetInputIndex(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustY)
                m_thrustZIndex = SetIndicesHandler.GetInputIndex(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesThrustZ)
                m_massIndex = SetIndicesHandler.GetInputIndex(AgEAsEOMFuncPluginInputStateValues.AgEAsEOMFuncPluginInputStateValuesTotalMass)
