...
BEGIN Scenario
    Name            Gator_EngMdl_Plugin_Examples

BEGIN Epoch
    Epoch        1 Jun 2004 12:00:00.000000
...
Stop                    5 Jun 2004 12:00:00.000000000
...
BEGIN Animation
    ...
    CurrentTime        1 Jun 2004 12:00:00.000000000
    Direction          Forward
...
BEGIN MapData
    ...
    BEGIN Map
        ...
        BEGIN MapAttributes
            PrimaryBody          Earth
            SecondaryBody        Sun
            CenterLatitude       89.341969
            CenterLongitude      -137.871504
...
END MapData
    ...
    FileType         Ephemeris
    Directory        C:\Program Files\AGI\STK 8\PluginSamples\STK\Gator\EngineModels\Scenario\
    UseTimePeriod    No
...
Class Satellite
	...
	Gator_EngMdl_CPP_Example1
	Gator_EngMdl_CSharp_Example1
	Gator_EngMdl_JScriptWsc_Example1
	Gator_EngMdl_VBScriptWsc_Example1
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/Gator_EngMdl_CPP_Example1
        Satellite/Gator_EngMdl_CPP_Example1
    END Instance
    Instance Satellite/Gator_EngMdl_CSharp_Example1
        Satellite/Gator_EngMdl_CSharp_Example1
    END Instance
    Instance Satellite/Gator_EngMdl_JScriptWsc_Example1
        Satellite/Gator_EngMdl_JScriptWsc_Example1
    END Instance
    Instance Satellite/Gator_EngMdl_VBScriptWsc_Example1
        Satellite/Gator_EngMdl_VBScriptWsc_Example1
    END Instance
END References
