...
4.	This plugin has already been registered in the "Engine Model" Category in the
	"Engine Model.xml" plugin point registration file; however the registration lies
	...
	<Plugin DisplayName = "CPP Example1" ProgID = "AGI.Astrogator.Plugin.Examples.EngineModeling.CPP.Example1.1"/>
...
7.  Use STK documentation for directions on how to configure an Engine Model Plugin for a 
    given satellite.
