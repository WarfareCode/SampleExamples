...
BEGIN Scenario
    Name            Gator_AttCtrl_Plugin_Examples
...
END MapData
    ...
    FileType         Ephemeris
    Directory        C:\Program Files\AGI\STK 8\PluginSamples\STK\Gator\AttitudeControllers\Scenario\
    UseTimePeriod    No
...
Class Satellite
	...
	Gator_AttCtrl_CPP_Example1
	Gator_AttCtrl_CSharp_Example1
	Gator_AttCtrl_JScriptWsc_Example1
	Gator_AttCtrl_VBScriptWsc_Example1
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Satellite/Gator_AttCtrl_CPP_Example1
        *
        Satellite/Gator_AttCtrl_CPP_Example1
    END Instance
    Instance Satellite/Gator_AttCtrl_CSharp_Example1
        *
        Satellite/Gator_AttCtrl_CSharp_Example1
    END Instance
    Instance Satellite/Gator_AttCtrl_JScriptWsc_Example1
        *
        Satellite/Gator_AttCtrl_JScriptWsc_Example1
    END Instance
    Instance Satellite/Gator_AttCtrl_VBScriptWsc_Example1
        *
        Satellite/Gator_AttCtrl_VBScriptWsc_Example1
    END Instance
END References
