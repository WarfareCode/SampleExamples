...
4.	This plugin has already been registered in the "Attitude Controls" Category in the
	...
	<Plugin DisplayName = "CPP Example1" ProgID = "AGI.Astrogator.Plugin.Examples.AttitudeControl.CPP.Example1"/>
...
7.  Use STK documentation for directions on how to configure an Attitude Controller Plugin for a 
    given satellite.
