...
Search Plugin Samples written in C#.
...
4.  This project's "Register for COM Interop" option has already been set to "true". 
...
6.	This plugin has already been registered in the "Search" Category in the
	...
	<Plugin DisplayName = "CSharp Bisection" ProgID = "AGI.Search.Plugin.Examples.CSharp.BisectionPlugin"/>
...
9.  Use STK documentation for directions on how to configure a Search Plugin for a 
    given satellite.
