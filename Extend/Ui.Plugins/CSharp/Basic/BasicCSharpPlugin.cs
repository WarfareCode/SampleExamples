...
{
	[Guid("9E113945-7472-4342-9AD8-CF572F51EAC1")]
    [ProgId("Agi.Ui.Plugins.CSharp.Basic")]
    [ClassInterface(ClassInterfaceType.None)]
    public class BasicCSharpPlugin : IAgUiPlugin, IAgUiPluginCommandTarget, IAgUiPlugin2
    {
        ...
        public void OnDisplayContextMenu(IAgUiPluginMenuBuilder MenuBuilder)
        {
            if (m_integrate)
            {
                ...
                string imageResource = "Agi.Ui.Plugins.CSharp.Basic.STK.ico";
