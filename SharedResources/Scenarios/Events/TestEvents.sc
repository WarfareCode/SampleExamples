...
BEGIN Epoch
    ...
    Epoch        1 Jun 2003 12:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Jun 2003 12:00:00.000000000
			EpochState	Explicit
...
BEGIN Animation
    ...
    CurrentTime        1 Jun 2003 12:00:00.000000000
    Direction          Forward
...
END MapData
    ...
    FileType         Ephemeris
    Directory        C:\Program Files\AGI\STK 8\Help\stkX\Samples\Scenario\events\
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Facility/Eden
        Facility/Eden
    END Instance
    Instance Facility/Edgewood
        Facility/Edgewood
    END Instance
    Instance Facility/Edinburg
        Facility/Edinburg
    END Instance
    Instance Facility/Edison
        Facility/Edison
    END Instance
    Instance Facility/Philadelphia
        Facility/Philadelphia
    END Instance
    Instance Facility/Phoenix
        Facility/Phoenix
    END Instance
    Instance Facility/Terrain
        Facility/Terrain
    END Instance
    Instance Satellite/tle-08747
        Satellite/tle-08747
    END Instance
    Instance Satellite/tle-10637
        Satellite/tle-10637
    END Instance
    Instance Satellite/tle-11852
        Satellite/tle-11852
    END Instance
    Instance Satellite/tle-13367
        Satellite/tle-13367
    END Instance
    Instance Satellite/tle-14129
        Satellite/tle-14129
    END Instance
    Instance Satellite/tle-14690
        Satellite/tle-14690
    END Instance
    Instance Satellite/tle-14780
        Satellite/tle-14780
    END Instance
    Instance Satellite/tle-14781
        Satellite/tle-14781
    END Instance
    Instance Satellite/tle-15199
        Satellite/tle-15199
    END Instance
END References
